...
namespace Es22._03.Banca
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Account BVespa = IntesaSanpaolo.createAccount("Bruno", "Vespa");
            Account BVespa2 = IntesaSanpaolo.createAccount("Bruno", "Vespa");
            Account RZero = IntesaSanpaolo.createAccount("Renato", "Zero");
            IntesaSanpaolo.addAccount(BVespa);
            IntesaSanpaolo.addAccount(BVespa2);
            IntesaSanpaolo.addAccount(RZero);
